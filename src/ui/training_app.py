...
from src.ui.global_status_bar import GlobalStatusBar
...
class TrainingApp(tk.Tk):
    ...
    def __init__(self):
        ...
        # 1. Initialize and pack the Global Status Bar at the top of the app window
        self.status_bar = GlobalStatusBar(self)
        self.status_bar.pack(side="top", fill="x", padx=10, pady=(10, 0))
    ...
    def show_context_help(self):
        ...
        if current_tab_widget == self.apply_tab:
            messagebox.showinfo(
                "Apply Training Help",
